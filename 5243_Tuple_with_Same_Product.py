...
class Solution:
    ...
    #                 if nums[i] != 1 and nums[i]*nums[k] % nums[j] != 0:
    #                     # print('pass')
    #                     continue

    #                 l = nums[i]*nums[k]/nums[j]
    #                 print(i, j, k)
    #                 print(nums[i], nums[j], nums[k], l)
    #                 if l.is_integer() and l <= nums[-1]:
    #                     if self.existed(nums[j+1:k], l):
    #                         ans += 8

    #     print(ans)
    #     return ans

    # def existed(self, elements, value):
    #     import bisect
...
print(slt.tupleSameProduct(nums) == 10576)
